...
from $tb_name1
   INNER JOIN $tb_name2 ON($tb_name1.attach_id=$tb_name2.attach_id)
	 where $tb_name2.record_ref_id='$way_id' and $tb_name1.lrd_attach_type='P_M'";   # ok de 55
 //echo $sql;exit;
$result=$db->query($sql);
 ...
 $attach_type=$rs['attach_type'];                                                                           #
  #-----------------------------------                                                                                                          #
	...
	// $db->del_data($tb_name1,$where);
	 $data4['filename_ref']	="";
	 //$where="where $tb_name2.record_ref_id='$way_id' and lrd_attach_type='P_M'";
...
AND lrd_attachment.lrd_attach_type='P_M')";
...
#................................................#
         ...
         $data3['file_size']	= $bytes;
			...
			//$data3['update_by']	= $_SESSION['LOGNAME'];
...
AND lrd_attachment.lrd_attach_type='P_M')";
		...
		// echo "to_this_here_line_134";
		// exit;
		         if($rs['attach_id']==""){       // echo $rs['attach_id'];exit;

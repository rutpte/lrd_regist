...
function Output($name='', $dest='')
{
	...
	switch($dest)
	{
		case 'I':
			...
			if(ob_get_length())  //var_dump(ob_get_length());// รับจำนวนตัวอีกษร       
				$this->Error('Some data has already been output, can\'t send PDF file 1');   ///////////////////////////////////////
		...
		case 'D':
			//Download file
			if(ob_get_length())
				$this->Error('Some data has already been output, can\'t send PDF file 3');  //////////////////////////////
			header('Content-Type: application/x-download');
			if(headers_sent())
				$this->Error('Some data has already been output, can\'t send PDF file 4'); //////////////////////////////////
			header('Content-Length: '.strlen($this->buffer));

...
<title>เลือกแสดงรายงานตารางสรุปการลงทะเบียนทางหลวงท้องถิ่น (ทถ.7)</title>
...
<form name="frm" method="post" 	action="show_report7.php" target="_blank" >
<table width="430" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td align="center" height="60" class="th_head_back14">เลือกแสดงรายงานตารางสรุปการลงทะเบียนทางหลวงท้องถิ่น (ทถ.7)<br />
      ในเขตพื้นที่สำนักงานทางหลวงชนบทจังหวัด<? echo $rsN['name_province'];?> <br />
<? echo $rsN['name_residence'];?> <br />
  ...
  <tr>
    <td align="center" height="50" valign="bottom"><input type="submit" name="Submit" value="แสดงผลรายงาน"    onclick="close_w();" /><input type="hidden" name="id_province" value="<? echo $id_province;?>" /></td>
  </tr>
</table>
</form>
</body>

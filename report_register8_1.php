...
$sql="SELECT `province`.id_province,`province`.name_province,`register_road`.id_mun
FROM
  `province`
  INNER JOIN `municipality` ON (`province`.`id_province` = `municipality`.`id_province`)
  INNER JOIN `register_road` ON (`municipality`.`id_mun` = `register_road`.`id_mun`) where  `register_road`.id_regis_detail!=0  and `province`.id_residence='$id_residence' GROUP BY `province`.id_province
...
FROM `municipality` where `municipality`.`id_province`='$rs[id_province]' 
";
...
where `province`.`id_province`='$rs[id_province]'
...
FROM
  ...
  where `register_road`.id_regis_detail!=0 and `province`.`id_province`='$rs[id_province]'";
  ...
  <td align="left" class="th11bblue"><? if($rs['id_province']!=""){?><? if($_SESSION['LOGTYPE']!=5&&$_SESSION['LOGTYPE']){?><a href="manage.php?page=report_register7&id_province=<? echo $rs['id_province']; ?>&list_year=<? echo $list_year;?>"><? echo $i+1?>.&nbsp;<? echo $rs['name_province'];?></a><? } else{ ?><a href="main.php?page=report7&id_province=<? echo $rs['id_province']; ?>&list_year=<? echo $list_year;?>"><? echo $i+1?>.&nbsp;<? echo $rs['name_province'];?></a><? }}?></td>
...
<table width="995" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>   <td align="left"><? if($_SESSION['LOGTYPE']!=5&&$_SESSION['LOGTYPE']){?><a href="manage.php?page=report_register9&part=2&list_year=<? echo $list_year;?>" class="th_red12b"><<<กลับหน้าตารางสรุปทถ.9</a><? }else{?><a href="main.php?page=report9&part=2&list_year=<? echo $list_year;?>" class="th_red12b"><<<กลับหน้าตารางสรุปทถ.9</a><? }?></td>
...
FROM
 ...
 if($rsSum['type_road']==1&&$rsSum['layer_road']==0){
  ...
  <td align="left" class="th11bblue"><? if($rs['id_province']!=""){?><? if($_SESSION['LOGTYPE']!=5&&$_SESSION['LOGTYPE']){?><a href="manage.php?page=report_register7&id_province=<? echo $rs['id_province']; ?>&part=2&list_year=<? echo $list_year;?>"><? echo $j+1?>.&nbsp;<? echo $rs['name_province'];?></a><? } else{ ?><a href="main.php?page=report7&id_province=<? echo $rs['id_province']; ?>&part=2&list_year=<? echo $list_year;?>"><? echo $j+1?>.&nbsp;<? echo $rs['name_province'];?></a><? }}?></td>
...
?>
<table width="995" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>   <td width="243" align="left"><? if($_SESSION['LOGTYPE']!=5&&$_SESSION['LOGTYPE']){?><a href="manage.php?page=report_register9&part=3&list_year=<? echo $list_year;?>" class="th_red12b"><<<กลับหน้าตารางสรุปทถ.9</a><? }else{?><a href="main.php?page=report9&part=3&list_year=<? echo $list_year;?>" class="th_red12b"><<<กลับหน้าตารางสรุปทถ.9</a><? }?></td>
    <td width="752" align="right" class="th12bblue"><? if($_SESSION['LOGTYPE']!=5&&$_SESSION['LOGTYPE']){?>
    <a href="manage.php?page=report_register8&id_residence=<? echo $id_residence?>&part=1&list_year=<? echo $list_year;?>" class="th12red_love">ในเขตชุมชน</a> / <a href="manage.php?page=report_register8&id_residence=<? echo $id_residence?>&part=2&list_year=<? echo $list_year;?>" class="th12red_love">นอกเขตชุมชน</a> / <span class="th12ora">รายงานความก้าวหน้า</span>  / <a href="report/show_report8.php?list_year=<? echo $list_year;?>?id_residence=<? echo $id_residence;?>" target="_blank" ><img src="image/pdf_icon.png" alt="แสดงรายงานในรูปแบบ pdf" width="20" align="absbottom" border="0" /></a><? }else{?>
...
<table width="995" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr bgcolor="#6699FF">
    ...
    <td width="145" align="center" class="th12bblue">สายทางในความ<br/>รับผิดชอบทั้งหมด</td>
...
FROM `annual_way` where `annual_way`.`id_province`='$rs[id_province]'  and list_year='$list_year'
";
 $resultSa1=$db->query($sqlSa1);
 $rsSa1=$db->fetch_array($resultSa1);

//$sum_amount_wayS+=$rsSa1['sum_amount_wayS'];
$sum_amount_phase_wayS+=$rsSa1['amount_phase_way'];
     $sqlSa="SELECT 
annual_way.amount_phase_way,province.name_province
FROM `residence` 
INNER JOIN `province` ON ( `residence`.`id_residence` = `province`.`id_residence` ) 
INNER JOIN `annual_way` ON ( `province`.`id_province` = `annual_way`.`id_province` ) 

where `province`.`id_province`='$rs[id_province]' and list_year='$list_year'
...
if($sum_amount_phase_way!=""){
 // $perClass=($sumClassT3*100)/$sum_amount_way;
  ...
  <td align="left" class="th11bblack"><? if($rs['id_province']!=""){?><? if($_SESSION['LOGTYPE']!=5&&$_SESSION['LOGTYPE']){?><a href="manage.php?page=report_register7&id_province=<? echo $rs['id_province']; ?>&part=3&list_year=<? echo $list_year;?>"><? echo $k+1?>.&nbsp;<? echo $rs['name_province'];?></a><? } else{ ?><a href="main.php?page=report7&id_province=<? echo $rs['id_province']; ?>&part=3&list_year=<? echo $list_year;?>"><? echo $k+1?>.&nbsp;<? echo $rs['name_province'];?></a><? }}?></td>

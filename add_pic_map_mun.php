...
<form id="form1" name="form1" method="post" action="manage_pic_regis_proc.php" enctype="multipart/form-data">
...
<table width="480" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCC33">
  ...
  <tr>
    ...
    <tr>
      ...
      <td align="left" bgcolor="#99CC99" class="th_red12b"><? echo $rs['way_code_head'].$rs['way_code_tail'];?></td>
    </tr>
    <tr>
     ...
     <tr>
    <td align="left" bgcolor="#006699" class="th16white">รูปภาพแผนที่</td>  <!--$rs['pic_map_mun']==""-->
    ...
    * นามสกุลไฟล์(jpg,jpeg,png,pdf)<br/>
    ...
    </span><? }else{?><a href="show_map_regis.php?way_id=<? echo $way_id;?>" target="_blank">ดูแผนที่</a> / <a href="manage_pic_regis_proc.php?way_id=<? echo $way_id;?>&chkdel=1">แก้ไขแผนที่</a><? }?></td>
  </tr>

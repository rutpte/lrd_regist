...
where way.way_id='$way_id' and lrd_attach_type='P_M'";  ###########
//echo $sql;exit;  //sql ok
  $result=$db->query($sql);
...
//echo $rootpath."/../image/no_image.png";  exit;
//echo $rootpath;exit;
...
#-----------------------------------------------------------------------------
  $type_file=explode(".",$rs['filename_ref']);     // var_dump($type_file[1]); exit;
  if($type_file[1]!="pdf"){   //var_dump($type_file[1]); exit;
 ...
 }else if($type_file[1]=="pdf"){  // var_dump($type_file[1]); //exit; //var_dump($download_path); exit; //var_dump($type_file[1]); exit;
		/* echo "<script>
				//window.location.href('download_map_regis.php?way_id=$way_id')
...
<div align="center"><br/>
 <input name="pic_print" id="pic_print" type="image"   src="image/b_print.gif" onClick="javascript:window.print();"/>
  <input type="button" id="printButton" onClick="javascript:window.print();" value="พิมพ์แผนที่" /><br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <!--aa href="download_map_regis.php?way_id=<? echo $way_id; ?>"> ดาวน์โหลด</a-->
   <a href="<? echo  $download_path;?>"> ดาวน์โหลด</a>
<!--http://cld.drr.go.th/util/download/index.php?src=D:/ms4w/apps/_cld_attach/WAY/9900015415/image/1356591984_Jellyfish.jpg&name=bb.jpg -->
  &nbsp;&nbsp;
...
<table width="601" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="">
        ...
        <td class="th14bgray"  align="center">ทชจ.&nbsp;<? echo $rs['province_name'];?>&nbsp;&nbsp;<? echo $rs['name_residence']?>
	     ...
	     <tr>
        <td class="th14bgray"  align="center">หน่วยงาน&nbsp;<? echo $rs['orgc_id'];?>  </td>
      </tr>
      <tr>
           <td class="th14bgray"  align="center">รหัสสายทาง&nbsp; <? echo $rs['way_code_head'].$rs['way_code_tail'];?></td>
  </tr>
      <tr>
        <td class="th14bgray_line"  align="center">ชื่อสายทาง&nbsp;<? echo $rs['way_name'];?>  </td>
      </tr>
...
?>
  ...
  <tr>  <?php //echo "http://".$rootpath."/../image/no_image.png";exit; ?>  
    <td align="center"><?php if($rs['filename_ref']=="" or $link_ok==0){?><img src="http://<?php echo $rootpath ?>/lrd_regis/image/no_image.png"  /><? }else{?><img src="http://<?php echo $file_for_resize; ?>"  /><? }?></td>
  </tr>

  ...
  <tr>
    <td class="th_head_back14" align="center"><table width="100%" border="0" cellspacing="2" cellpadding="2">
      <tr>
	    ...
	    <tr>
        <td class="th_head_back16"  align="center">ในเขตพื้นที่สำนักงานทางหลวงชนบทจังหวัด<? echo $rsN['province_name'];?> <? echo $rsN['name_residence'];?></td>
      </tr>
	     <tr>
...
<table width="980" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <? $i=0; 
 /*    $sqlSa1="SELECT  
sum(org_comunity.amount_way) as sum_amount_wayS,sum(org_comunity.amount_phase_way) as sum_amount_phase_wayS
FROM org_comunity where org_comunity.province_id='$province_id'
";
...
/*   $sqlSa="SELECT  (
org_comunity.amount_way
), (
org_comunity.amount_phase_way
)
FROM residence 
INNER JOIN province ON ( residence.id_residence = province.id_residence ) 
INNER JOIN org_comunity ON ( province.province_id = org_comunity.province_id )

WHERE org_comunity.orgc_id='$rs[orgc_id]'
GROUP BY org_comunity.orgc_id
...
FROM
  ...
  ?>
  <tr>
    <td align="left" class="th11bblue"><? if($rs['orgc_id']!=""){?>
      <? if($_SESSION['LOGTYPE']!=5&&$_SESSION['LOGTYPE']){?>
      <a href="manage.php?page=report_register6&orgc_id=<? echo $rs['orgc_id']; ?>&list_year=<? echo $list_year;?>&show=<? echo $show;?>&s_date=<? echo $s_date;?>&e_date=<? echo $e_date;?>"><? echo $i+1?>.&nbsp; <? echo $rs['orgc_name'];?></a>
      <? }else{ ?>
      <a href="main.php?page=report6&orgc_id=<? echo $rs['orgc_id']; ?>&list_year=<? echo $list_year;?>&show=<? echo $show;?>&s_date=<? echo $s_date;?>&e_date=<? echo $e_date;?>"><? echo $i+1?>.&nbsp; <? echo $rs['orgc_name'];?></a>
      <? } }?></td>
...
FROM
 ...
 if($rsSum['type_road']==1&&$rsSum['layer_road']==0){
  ...
  <tr>
    <td align="left" class="th11bblue"><? if($rs['orgc_id']!=""){?>
      <? if($_SESSION['LOGTYPE']!=5&&$_SESSION['LOGTYPE']){?>
      <a href="manage.php?page=report_register6&orgc_id=<? echo $rs['orgc_id']; ?>&list_year=<? echo $list_year;?>&show=<? echo $show;?>&s_date=<? echo $s_date;?>&e_date=<? echo $e_date;?>"><? echo $j+1?>.&nbsp; <? echo $rs['orgc_name'];?></a>
      <? }else{ ?>
      <a href="main.php?page=report6&orgc_id=<? echo $rs['orgc_id']; ?>&list_year=<? echo $list_year;?>&show=<? echo $show;?>&s_date=<? echo $s_date;?>&e_date=<? echo $e_date;?>"><? echo $j+1?>.&nbsp; <? echo $rs['orgc_name'];?></a>
      <? } }?></td>
...
$sumNumT3=$sumD1+$sumD2;
  ...
  <tr>
    <td align="left" class="th11bblue"><? if($rs['orgc_id']!=""){?>
      <? if($_SESSION['LOGTYPE']!=5&&$_SESSION['LOGTYPE']){?>
      <a href="manage.php?page=report_register6&orgc_id=<? echo $rs['orgc_id']; ?>&list_year=<? echo $list_year;?>&show=<? echo $show;?>&s_date=<? echo $s_date;?>&e_date=<? echo $e_date;?>"><? echo $k+1?>.&nbsp; <? echo $rs['orgc_name'];?></a>
      <? }else{ ?>
      <a href="main.php?page=report6&orgc_id=<? echo $rs['orgc_id']; ?>&list_year=<? echo $list_year;?>&show=<? echo $show;?>&s_date=<? echo $s_date;?>&e_date=<? echo $e_date;?>"><? echo $k+1?>.&nbsp; <? echo $rs['orgc_name'];?></a>
      <? } }?></td>
